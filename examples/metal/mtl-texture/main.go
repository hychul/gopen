...
const (
    ...
    fragment float4 FragmentShader(
        ...
        constexpr sampler textureSampler(mip_filter::nearest, mag_filter::nearest, min_filter::nearest);
...
var (
	...
	// vertices = [...]float32{
	//    X,    Y,    Z,    W, U, V, _, _
	// -100, +100, 0.00, 1.00, 1, 0, 0, 0, // left-top
	// -100, -100, 0.00, 1.00, 1, 1, 0, 0, // left-bottom
	// +100, -100, 0.00, 1.00, 0, 1, 0, 0, // right-bottom
	// +100, -100, 0.00, 1.00, 0, 1, 0, 0, // right-bottom
	// +100, +100, 0.00, 1.00, 0, 0, 0, 0, // right-top
	// -100, +100, 0.00, 1.00, 1, 0, 0, 0, // left-top
	// }
